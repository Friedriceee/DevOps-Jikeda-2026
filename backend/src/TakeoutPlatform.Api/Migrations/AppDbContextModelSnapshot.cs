...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TakeoutPlatform.Api.Features.Auth.Account", b =>
                {
                    ...
                    b.HasIndex("Role", "ProfileId")
                        .IsUnique();

                    b.ToTable("Accounts");
                });

            modelBuilder.Entity("TakeoutPlatform.Api.Features.Cart.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TakeoutPlatform.Api.Features.Merchant.Merchant", b =>
                {
                    ...
                    b.Property<string>("WalletPasswordHash")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("TakeoutPlatform.Api.Features.Cart.CartItem", b =>
                {
                    b.HasOne("TakeoutPlatform.Api.Features.Merchant.Dish", "Dish")
                        .WithMany()
